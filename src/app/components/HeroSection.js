...
export default function HeroSection() {
  ...
  const bgImage = isDark
    ? 'linear-gradient(to bottom, rgba(10,6,20,0.6) 0%, rgba(10,6,20,0.78) 60%, #0f0f0f 100%), url("https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1400&q=80")'
    : 'linear-gradient(to bottom, rgba(240,235,255,0.82) 0%, rgba(245,240,255,0.92) 60%, #f4f4f6 100%), url("https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1400&q=80")';
